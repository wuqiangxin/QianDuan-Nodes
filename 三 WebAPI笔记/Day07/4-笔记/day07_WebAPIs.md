...
![](images\移动轮播图分析01.png)

具体的拖拽同时再自动切换的效果如下：   （这里的切换是定时器的带动画的切换）

![](images\移动端轮播图分析02-拖拽同时自动切换效果.gif)



其实跟拖拽同时瞬间切换的效果是类似的，**总之拖拽的时候，是不能再通过代码切换轮播图**
