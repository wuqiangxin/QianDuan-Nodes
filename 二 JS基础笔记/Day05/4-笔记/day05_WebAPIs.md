...
![](images\jd-big-fenxi01.png)

![](images\jd-big-fenxi02.png)
...
- 主要作用： 创建一个独立的作用域，避免了命名冲突问题。
  ...
  - 所以，立即执行函数**真正的作用就是立即执行**（缺点：只能调用一次）
